...
The following example clones the "[OTW update](https://github.com/Infineon/mtb-example-psoc-edge-otw-update)" application with the desired name "OtwUpdate" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-otw-update --user-app-name OtwUpdate --target-dir "C:/mtb_projects"
   ```
